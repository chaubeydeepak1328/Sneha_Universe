...
export default function UserPanel() {
            ...
            <div className="max-w-6xl mx-auto ">
                ...
                <div className="flex flex-col lg:flex-row justify-between mt-10 mx-4 md:mx-10 gap-10">
                    ...
                    <div className="">
                        ...
                        <div className="grid grid-cols-1 mt-10 rounded-2xl p-6 text-center bg-cyan-400/10
    flex
    items-center
    justify-center
    mx-auto
    ...
    duration-300   border-1 rounded-2xl p-6 text-center" >
                            <div className="mt-10">
                                <span className="border-2 text-2xl px-12 py-2 bg-cyan-400/10 border-cyan-400 rounded-2xl"> Detailed View</span>
                            </div>
                            <div className="mt-10">
                                <span className="border-2 text-2xl px-12 py-2 bg-cyan-400/10 border-cyan-400  rounded-2xl">slot {slotIndex + 1}</span>
                            </div>
                        ...
                        <div className="w-full overflow-x-auto py-4 mt-3 max-w-6xl mx-auto border border-cyan-400 rounded-xl">
                            {/* Selection Controls */}
