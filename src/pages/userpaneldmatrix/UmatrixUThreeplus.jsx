...
export default function UserPanel() {
  ...
  return (
    ...
    backdrop-blur-md
    transition-all
    duration-300  border border-cyan-400 text-cyan-400 px-4 py-1 text-sm font-medium  items-center justify-center flex flex-col rounded-2xl w-full lg:w-[700px] p-10 py-4 text-center backdrop-blur-md shadow-xl  border-1 rounded-2xl p-6 text-center border-1 rounded-2xl p-6 text-center border-1 rounded-2xl p-6 text-center"
              //   style={{
              //     background:
