      ...
      <div className="max-w-6xl mx-auto ">
        ...
        <div className="flex flex-col lg:flex-row justify-between mt-10 mx-4 md:mx-10 gap-10">
          ...
          <div className="">
            ...
            {/* Universe U5 Section */}
            <div
              className="grid grid-cols-1 mt-10 rounded-2xl p-1 text-center
    bg-cyan-400/10
    items-center
    justify-center
    mx-auto
              ...
              <div className="flex items-center justify-between">
                ...
                <div>
                  ...
                  <div className="flex flex-col items-center gap-4 mt-10">
                    <div className="mt-10">
                      <span className="rounded-xl border-2 text-[12px] bg-cyan-400/10 lg:text-2xl px-6 lg:px-12 py-2 ">
                        Matrix ID {id ? id : "0"}
                      </span>
                    </div>
                        ...
                        <button
                          onClick={() => {
                            if (id == "N/a") {
                              ...
                              navigate("/user-panel-home/universe", {
                                state: {
                                  id: id,
                                  slotVal: 0,
