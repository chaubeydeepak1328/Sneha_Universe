...
export default function UserPanel() {
  ...
  return (
      ...
      <div className="max-w-6xl mx-auto ">
        ...
        <div className="flex flex-col lg:flex-row justify-between mt-10 mx-4 md:mx-10 gap-10">
          ...
          <div className="">
            ...
            {/* Universe U5 Section */}
            <div
              className="grid grid-cols-1 mt-10 rounded-2xl p-2 text-center
    bg-cyan-400/10
    flex
    items-center
    justify-center
    ...
    backdrop-blur-md
    transition-all
    duration-300  border border-cyan-400 text-cyan-400 px-2 py-1 text-sm font-medium  items-center justify-center flex flex-col rounded-2xl w-full lg:w-[700px] py-4 text-center backdrop-blur-md shadow-xl  border-1 rounded-2xl  text-center border-1 rounded-2xl  text-center"
            // style={{
            //   background:
              ...
              <div className="flex justify-between items-center">
                ...
                <div>
                  ...
                  <div className="flex flex-col items-center gap-4 mt-10">
                    <div className="mt-10">
                      <span className="rounded-xl border-2 text-[12px] lg:text-2xl px-6 lg:px-12 py-2 ">
                        Matrix ID {id ? id : "0"}
                      </span>
                    </div>
                        ...
                        <button
                          ...
                          onClick={() => {
                            if (id == "N/a") {
                              ...
                              navigate("/user-panel-home/UniverseU4", {
                                state: {
                                  id: id,
                                  slotVal: 0,
    ...
    backdrop-blur-md
    transition-all
    duration-300  border border-cyan-400 text-cyan-400 px-4 py-1 text-sm font-medium  items-center justify-center flex flex-col rounded-2xl w-full  py-4 text-center backdrop-blur-md shadow-xl  border-1 rounded-2xl  text-center"
                    >
    ...
    backdrop-blur-md
    transition-all
    duration-300  border border-cyan-400 text-cyan-400 px-4 py-1 text-sm font-medium  items-center justify-center flex flex-col rounded-2xl  p-10 py-4 text-center backdrop-blur-md shadow-xl  border-1 rounded-2xl p-6 text-center"
                    >
