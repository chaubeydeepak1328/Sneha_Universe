  ...
  return (
      ...
      <div className="max-w-6xl mx-auto ">
        ...
        <div className="flex flex-col lg:flex-row justify-between mt-10 mx-4 md:mx-10 gap-10">
          ...
          <div className="">
            ...
            <div
              className="grid grid-cols-1 mt-10 rounded-2xl p-3 text-center rounded-2xl  bg-cyan-400/10
    items-center
    justify-center
    mx-auto
    border-cyan-400
    ...
    duration-300   border-1 rounded-2xl  text-center"
            >
              <div>
                <div className="mt-10">
                  <span className="border-2 text-2xl px-12 py-2 border-cyan-400 bg-cyan-400/10 rounded-2xl">
                    {" "}
                    Detailed View
                  </span>
                </div>
